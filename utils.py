...
# Enumerated Types
# An enumeration of the possible events that can occur in the application.
APP_EVENT = Enum(
    "APP_EVENT",
    "APP_EXIT,BUTTONCLICK,DWCLICK,DWDOUBLECLICK,MENUCLICK,WINCASCADE,WINCLOSE,WINNEW,WINTILED",
)
