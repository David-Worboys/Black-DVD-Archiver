...
* Download the "black-dvd-archiver" (https://github.com/David-Worboys/Black-DVD-Archiver/releases/tag/%CE%B22.1.0) to 
...
The operation of these buttons is as follows:
  ...
  * ![](./userguide_images/join_button.png) — Join the checked (selected) video files.
